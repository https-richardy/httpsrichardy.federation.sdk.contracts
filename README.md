# HttpsRichardy.Federation.Sdk.Contracts

This project contains the set of contracts (interfaces and data models) for the Federation SDK. It is designed to allow your application to depend only on abstractions instead of concrete implementations, facilitating the adoption of Clean Architecture patterns.
